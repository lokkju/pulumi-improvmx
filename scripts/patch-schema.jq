...
| .resources["improvmx:index:EmailAlias"].properties.domain.language.csharp.name = "DomainName"
| .resources["improvmx:index:SmtpCredential"].inputProperties.domain.language.csharp.name = "DomainName"
| .resources["improvmx:index:SmtpCredential"].properties.domain.language.csharp.name = "DomainName"
